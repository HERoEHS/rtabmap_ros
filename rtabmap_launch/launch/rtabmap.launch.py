...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg',      default_value='~/.rtabmap/test.ini',                        description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        ...
        DeclareLaunchArgument('database_path',  default_value='~/.ros/rtabmap_v2.db',  description='Where is the map saved/loaded.'),
        ...
        # DeclareLaunchArgument('stereo_namespace',        default_value='', description=''),
        # DeclareLaunchArgument('left_image_topic',        default_value=[LaunchConfiguration('stereo_namespace'), '/zed/zed_node/left/image_rect_color'], description=''),
        # DeclareLaunchArgument('right_image_topic',       default_value=[LaunchConfiguration('stereo_namespace'), '/zed/zed_node/right/image_rect_color'], description='Use grayscale image for efficiency'),
        # DeclareLaunchArgument('left_camera_info_topic',  default_value=[LaunchConfiguration('stereo_namespace'), '/zed/zed_node/left/camera_info'], description=''),
        # DeclareLaunchArgument('right_camera_info_topic', default_value=[LaunchConfiguration('stereo_namespace'), '/zed/zed_node/right/camera_info'], description=''),
